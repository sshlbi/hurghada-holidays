...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-deep-2 text-sand/90 pt-12 pb-7 px-5 mt-10"
        ...
        <div className="grid grid-cols-[2fr_1fr_1fr] max-[700px]:grid-cols-1 gap-8 mb-8">
          <div ref={col1} className="reveal">
            ...
            <div className="flex gap-3 mt-3.5">
              <a href="https://wa.me/201093835275" target="_blank" rel="noopener" aria-label="WhatsApp" className="w-[38px] h-[38px] rounded-full bg-white/10 grid place-items-center text-white hover:bg-coral transition-colors">
              ...
              <a href="mailto:hurghadaholidays434@gmail.com" aria-label="Email" className="w-[38px] h-[38px] rounded-full bg-white/10 grid place-items-center text-white hover:bg-coral transition-colors">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener" aria-label="Facebook" className="w-[38px] h-[38px] rounded-full bg-white/10 grid place-items-center text-white hover:bg-coral transition-colors">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener" aria-label="Instagram" className="w-[38px] h-[38px] rounded-full bg-white/10 grid place-items-center text-white hover:bg-coral transition-colors">
          ...
          <div ref={col2} className="reveal">
            ...
            <ul className="flex flex-col gap-2 text-[0.9rem]">
              <li><a href="mailto:hurghadaholidays434@gmail.com" className="hover:text-coral">hurghadaholidays434@gmail.com</a></li>
              <li><a href="tel:+201093835275" className="hover:text-coral">+20 109 383 5275</a></li>
              <li>{t("location")}</li>
            </ul>
          </div>
          <div ref={col3} className="reveal">
            ...
            <ul className="flex flex-col gap-2 text-[0.9rem]">
              ...
              <li><a href="#reviews" className="hover:text-coral">{t("navReviews")}</a></li>
            </ul>
          </div>
        </div>
