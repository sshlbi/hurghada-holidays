  ...
  return (
    <div className="p-6 max-[480px]:p-4 bg-surface rounded-2xl border border-border shadow-soft">
      <div className="flex justify-between items-center gap-3 mb-4 flex-wrap">
        ...
        <button type="button" onClick={skipTransport} className="rounded-full border border-border px-4 py-2 font-medium text-[0.85rem] text-deep transition-colors duration-200 hover:border-coral/40 hover:text-coral">
          {t("skip")}
        </button>
      </div>
